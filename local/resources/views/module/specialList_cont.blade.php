<div class="main">
	...
	<div class="medicinal-w3">
		<div class="container">
			<div class="sub-hd">
				<h3 class="tittle two">Các chuyên khoa</h3>
			</div>
			<div class="medicinal-w3-grids">
				<div class="col-md-12 medicinal-w3-grid">
					<div class="col-md-4 medicinal-w3-right">
						<div class="hi-icon-wrap hi-icon-effect-7 hi-icon-effect-7b">
							<a href="/LuonBenBan_CNPM/chi-tiet-khoa/khoaSan" class="hi-icon icon2"></a>
						</div>
					</div>
					<div class="col-md-8 medicinal-w3-left1">
						<h4>1.Sản phụ khoa</h4>
						<p>
							...
							<button class="btn btn-info txtInfoKhoa"><a href="/LuonBenBan_CNPM/chi-tiet-khoa/khoaSan">Tìm hiểu thêm</a></button>
						</p>
					</div>
				...
				<div class="col-md-12 medicinal-w3-grid">
					...
					<div class="col-md-8 medicinal-w3-left1">
						...
						<p>
							Là một bốn phân ngành y khoa quan trọng của khối lâm sàng. Khoa có chức năng chẩn đoán và điều trị các bệnh lý và dự phòng sức khỏe của nữ giới, bao gồm phụ nữa còn độc thân và đã mang thai, sinh con. Khoa có thể được phân tách thành Sản khoa và phụ khoa.
							<button class="btn btn-info txtInfoKhoa"><a href="/CNPM/chiTietKhoa">Tìm hiểu thêm</a></button>
						</p>
					</div>
					<div class="clearfix"></div>
				</div>
